...
use MakeupBundle\Form\UserType;
use MakeupBundle\Entity\User;
...
class UserController extends Controller {
    ...
    public function loginAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            $user_repo = $em->getRepository("MakeupBundle:User");
        ...
        return $this->render('MakeupBundle:User:login.html.twig', array(
                    "error" => $error,
